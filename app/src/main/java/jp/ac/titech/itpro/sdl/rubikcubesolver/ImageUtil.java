...
public class ImageUtil {
    ...
    // color definition
    public static final double[][] colorData = {
            {255, 215, 0, 0},    // Y
            {254, 80, 0, 0},     // O
            {0, 154, 68, 0},     // G
            {255, 255, 255, 0},  // W
    ...
    public static final String[] colorLabel = {"Y", "O", "G", "W", "R", "B"};
    public static final String[] colorName = {"Yellow", "Orange", "Green", "White", "Red", "Blue"};
    public static final List<Integer> colorResponse = new ArrayList<>(Arrays.asList(0, 1, 2, 3, 4, 5));
    // top -> left -> down -> right
    public static final String[] arrSideColors = {
            "BRGO",  // Yellow
            "YGWB",  // Orange
            "YRWO",  // Green
            "GRBO",  // White
    ...
    // Error Message
    public static final String[] verifyMsg = {
    ...
    public static String convertCubeAnnotation(String scannedCube) {
        return scannedCube
                .replace("Y", "U")
                .replace("R", "L")
                .replace("G", "F")
    ...
    public static Mat calcBoxColorAve(Mat mat, int boxX, int boxY, int boxLen) {
    ...
    public static Mat calcMovingAveColor(@Nullable Mat matPrev, Mat matCurrent, float alpha) {
        if (matPrev == null) {
            return matCurrent;
        }
